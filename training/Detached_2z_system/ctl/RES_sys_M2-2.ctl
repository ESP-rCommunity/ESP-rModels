...
0.16                  # (13a) if (12) is set to "2"; grid rate threshold value above which "grid rate low" is false
../ctl/GridRate.fcl   # (13b) if (12) is set to "2"; grid rate data file
2                     # (14) grid refund toggle
0.22                  # (14a) if (13) is set to "2"; grid refund threshold value below which "grid refund high" is false
