...
#@calcprocedures = ( "diluted", "gensky", "composite", "groundreflections", "report" ) ;
...
$parproc = 4; # NUMBER OF PARALLEL PROCESSORS. NOT MANDATORY. FOR PARALLEL CALCULATIONS IN RADIANCE.
