...
*SPECDATA
13                  
42.2      Open circuit voltage. (V)
7.15      Short circuit current. (I)
34.3      Voltage at maximum power point (V)
6.72      Current at maximum power point (A)
...
16.        Number of panels in surface. (-)
...
*SPECDATA
57	 0
16.0      Battery capacity (kWh)
0.15      Battery discharge per km (kWh/km)
0.00      Battery parasitic losses (kWh/hr)
90.0      Battery charging efficiency (%)
50.0      Initial battery state of charge (%)
20.0      Battery minimum state of charge (%)
0.50      Disconnect whilst charging probability modifier (-)
8200.0    Nominal annual car use (km)
8.50      Average trip distance (out and return) (km)
0.0000    Trip distance equation a0
5.26432   Trip distance equation a1
12.16438  Trip distance equation a2
28.24043  Trip distance equation a3
1800.0    Stay lockout (s)
1800.0    Trip lockout (s)
110.0     Maximum vehicle speed (km/h)
1         Number of holiday periods vehicle is absent (-)
181       Holiday period start
194       Holiday period end
6         Number of weekday time periods 
0.0       period start
0.00535   trip (1-leg) probability in Wkdy period
7.0       period start
0.00842   trip (1-leg) probability in Wkdy period
10.0      period start
0.06372   trip (1-leg) probability in Wkdy period
15.0      period start
0.09153   trip (1-leg) probability in Wkdy period
18.0      period start
0.05325   trip (1-leg) probability in Wkdy period
21.0      period start
0.01525   trip (1-leg) probability in Wkdy period
5         Number of Saturday time periods 
0.0       period start
0.06031   trip (1-leg) probability in period
8.0       period start
0.05662   trip (1-leg) probability in period
10.0      period start
0.09209   trip (1-leg) probability in period
15.0      period start
0.06052   trip (1-leg) probability in period
21.0      period start
0.01872   trip (1-leg) probability in Sat period
4         Number of Sunday time periods 
0.0       period start
0.01284   trip (1-leg) probability in Sun period
10.0      period start
0.09036   trip (1-leg) probability in Sun period
17.0      period start
0.04873   trip (1-leg) probability in Sun period
21.0      period start
0.01473   trip (1-leg) probability in Sun period
3.0       number of charging control data items
1.0       charging type	(dumb charge)
32.0      maximum charging current (A)
220.0     nominal charging voltage (V)
12345.0   random seed
*TEXT
Electric vehicle model, for use in vehicle-to-home or grid simulations. Calibrates using 2013 UK DfT
road transport data.
*ENDTEXT
*END
*POWOCOMP
...
*SPECDATA
2	 0
3.0      Entity id number in tdf database.
1.0      Profile scaling factor (-).
*TEXT
Component that reads text from a temporal data file. 
*ENDTEXT
*END
*POWOCOMP
*IDDATA
