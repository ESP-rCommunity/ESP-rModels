...
*date Wed Sep 21 13:07:46 2022  # latest file modification 
...
*surf,glazing,VERT,-,-,-,dbl_glz,DCF7671_06nb,EXTERIOR,00,000  #   9 ||< external
...
# 
*bridge_start,0.000,0.000,1.438,0.000  # user fraction,losspercent W/K, total heat loss W/K and total UA W/K
*ukt_bridge,wall-intermediate-floor,  6.000,  0.0700  # type length psi value
*ukt_bridge,wall-partition,  6.000,  0.0600  # type length psi value
*ukt_bridge,glass-frame,  9.400,  0.0700  # type length psi value
*end_bridge
