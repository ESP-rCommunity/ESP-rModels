...
# senses node (2) general
   -4    2    0    0  # sensor data
# actuates flow connection:  12 south_gen - general via fac_vent3s
...
# senses node (2) general
   -4    2    0    0  # sensor data
# actuates flow connection:  13 east_gener - general via fac_vent_2e
...
# senses node (3) conference
   -4    3    0    0  # sensor data
# actuates flow connection:  15 east - conference via fac_vent_ce
