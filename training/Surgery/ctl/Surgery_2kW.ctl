...
# Function:Zone links
 1,1
*mass flow
*fdoc extract fan on if gr 23C
   1                        # number of loops
*loop   1 fan
   -4    2    0    0        # senses node (2) examination
   -3   11    0             # actuates flow connection:  11 examination - BW-EX02:013 via GrEXz02:013
    1                       # all day types have same control
    1  365    1             # valid Mon-01-Jan - Mon-31-Dec, periods in weekdays
    1    0   0.000   3.     # type (dry bulb > flow), law (on / off), start@
22.00000 1.00000 1.00000    # on/off setpoint 22.00 direct action ON fraction 1.000.
