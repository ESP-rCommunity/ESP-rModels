*CONTROL
*cdoc Living and hall are heated other rooms free-float and are at risk of con densation.
*building
*zdoc no descrip
*scope HEATONLY    
   2                        # number of loops
...
*loop   1 optical_loop_01
   -7   13    1             # senses radiation at - in hall_2.
    0    0    1             # actuates undefined actuator
    1                       # all day types have same control
    1  365    1             # valid Fri-01-Jan - Fri-31-Dec, periods in weekday
    0    2   0.000   1.     # ctl type, law (tmc optical switching), start @, data items
