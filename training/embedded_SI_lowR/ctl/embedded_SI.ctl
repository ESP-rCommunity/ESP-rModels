...
*loop   1 varying setpoints
  ...
  3000.000 0.000 0.000 0.000 15.000 100.000  # basic control: heating capacity 3000.0W. heating setpoint 15.00C. (missing 7th item)
    0    1   9.000   6.     # ctl type, law (basic control), start @, data items
  3000.000 0.000 0.000 0.000 20.000 100.000  # basic control: heating capacity 3000.0W. heating setpoint 20.00C. (missing 7th item)
