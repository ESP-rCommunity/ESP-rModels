...
*cdoc AHU system
*building
*zdoc AHU plant with return coupled to zone 1
*scope HEATCOOL    
   1                        # number of loops
*loop   1 reception cpld plant 5
  ...
  5.000 4.000 1.000 1000.000 1000.000 6.000 1.000  # plant/zone coupling: source plant component 5 plant component node 4 coupling type mCp(0s-0a) sequential. Max heating 1000.00W max cooling 1000.00W. Extract plant component 6 and extract node 1.
# Function:Zone links
 1,0,0
*plant
*pdoc Single zone AHU.
   1                        # number of loops
*loop   1 heater
   -1    6    1    0    0  # senses var in compt.  6:return_duct @ node no.  1
