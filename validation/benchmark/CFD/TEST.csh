...
#              tm1.dfd porous.dfd tst33vol.dfd tm2_so.dfd)
#     @ test ++
#     echo "Test "$test": "$i" with the default solver."
#     cd Models; ./dfs_basic.csh $DFS $i; echo $i; sleep 1; cd ..
#   end
# endif
# #
...
#     cd Models; ./dfs_bi-cg.csh $DFS $i; echo $i; sleep 1; cd ..
#   end
# endif
#
...
#     cd Models; ./dfs_ggdh_not_conv.csh $DFS $i; echo $i; sleep 1; cd ..
#   end
# endif
#
...
if ( $A == 1 || $A == 3 ) then
  foreach i (displ.dfd displ_si.dfd tm1_so.dfd)
    @ test ++
    echo "Test "$test": "$i" with the default solver."
    cd Models; ./dfs_not_conv.csh $DFS $i; echo $i; sleep 1; cd ..
  end
endif
#
...
#
if ( $A == 2 || $A == 3 ) then
  foreach i (blockt.dfd tm1b.dfd tm1a.dfd)
    @ test ++
    echo "Test "$test": "$i" with the default solver."
    cd Models; ./dfs_basic.csh $DFS $i; echo $i; sleep 1; cd ..
  end
...
if ( $A == 2 || $A == 3 ) then
  foreach i (bi-cg.dfd)
    @ test ++
    echo "Test "$test": "$i" with the bi-cg solver."
    cd Models; ./dfs_bi-cg_not_conv.csh $DFS $i; echo $i; sleep 1; cd ..
  end
endif
#
