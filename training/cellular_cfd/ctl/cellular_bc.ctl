...
# Function:Zone links
 1,1,1
*mass flow
*fdoc sash window upper and lower separately controlled.
   4                        # number of loops
*loop   1 manager a low
   -4    1    0    0        # senses node (1) mana
   -3    1    0             # actuates flow connection:   1 alow - mana via low_win
...
*loop   2 manager a high
   -4    1    0    0        # senses node (1) mana
   -3    2    0             # actuates flow connection:   2 ahi - mana via high_win
    1                       # all day types have same control
    1  365    1             # valid Sun-01-Jan - Sun-31-Dec, periods in weekdays
    1    2   0.000   6.     # type (dry bulb > flow), law (low/default/mid/hi), start@
  19.10000 21.00000 26.00000 0.10000 1.50000 0.10000  # range setpoints: low 19.10 mid 21.00 high 26.00 actuation ranges: low (< low sp) 0.10 mid (>mid sp) 1.50 high (>high sp) 0.10.
*loop   3 manager b low
   -4    2    0    0        # senses node (2) manb
   -3    3    0             # actuates flow connection:   3 blow - manb via low_win
    1                       # all day types have same control
    1  365    1             # valid Sun-01-Jan - Sun-31-Dec, periods in weekdays
    1    2   0.000   6.     # type (dry bulb > flow), law (low/default/mid/hi), start@
  19.10000 21.00000 26.00000 0.10000 1.50000 0.10000  # range setpoints: low 19.10 mid 21.00 high 26.00 actuation ranges: low (< low sp) 0.10 mid (>mid sp) 1.50 high (>high sp) 0.10.
*loop   4 manager b high
   -4    2    0    0        # senses node (2) manb
   -3    4    0             # actuates flow connection:   4 bhi - manb via high_win
    1                       # all day types have same control
    1  365    1             # valid Sun-01-Jan - Sun-31-Dec, periods in weekdays
    1    2   0.000   6.     # type (dry bulb > flow), law (low/default/mid/hi), start@
  19.10000 21.00000 26.00000 0.10000 1.50000 0.10000  # range setpoints: low 19.10 mid 21.00 high 26.00 actuation ranges: low (< low sp) 0.10 mid (>mid sp) 1.50 high (>high sp) 0.10.
