*CONTROL
*cdoc Cooler comfort settings - 17 C in bedrooms, 19 C in living areas. Function 1 for bedrooms, 2 for hall, 3 for study, 4 for living and 5 for kitchen.
*building
...
*loop   1 upper rooms
  ...
  1000.000 0.000 0.000 0.000 17.000 100.000 0.000  # basic control: heating capacity 1000.0W. heating setpoint 17.00C.
...
*loop   4 lounge
    ...
    0    2   0.000   0.     # ctl type, law (free floating), start @, data items
    0    1   6.000   7.     # ctl type, law (basic control), start @, data items
  1300.000 0.000 0.000 0.000 19.000 100.000 0.000  # basic control: heating capacity 1300.0W. heating setpoint 19.00C.
    0    2   9.000   0.     # ctl type, law (free floating), start @, data items
    0    1  13.000   7.     # ctl type, law (basic control), start @, data items
  1300.000 0.000 0.000 0.000 19.000 100.000 0.000  # basic control: heating capacity 1300.0W. heating setpoint 19.00C.
    0    1  18.000   7.     # ctl type, law (basic control), start @, data items
